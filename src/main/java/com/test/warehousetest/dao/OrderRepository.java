...
@Repository
public interface OrderRepository extends HistoryBaseRepository<Order, Long> {
    @Query(value = "select t.day, sum(t.amount) as totalSum " +
                      "from (select date_trunc('day', o.\"timestamp\") as day, o.amount from orders o " +
